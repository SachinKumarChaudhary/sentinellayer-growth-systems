...
def main() -> int:
    ...
    with psycopg.connect(db_url) as conn:
        with conn.cursor() as cur:
            ...
            payload = []
            numeric = {"rank", "estimated_monthly_sales", "estimated_monthly_visits", "estimated_monthly_pageviews", "employee_count", "installed_apps_count"}
            for row_no, domain, row in normalized:
                item = {
                    ...
                    **{k: row[k] or None for k in EXPECTED_COLUMNS if k not in numeric},
