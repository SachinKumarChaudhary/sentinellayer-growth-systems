import pytest
from sentinellayer_growth_engine.enrollment import CampaignEnrollmentService, CampaignNotReady, EnrollmentConflict, EnrollmentRequest
...
def test_invalid_priority_is_rejected():
    with pytest.raises(ValueError, match='invalid priority'): CampaignEnrollmentService(Store()).enroll(request(priority='P9'))