"""Machine-readable contract-version gate used by Platform tests."""
...
def test_unsupported_versions_are_rejected_by_machine_registry(
    contract: str, version: str
) -> None:
    assert not supported(contract, version)


def test_registered_versions_are_supported() -> None:
